...
const routes: Routes = [
  ...
  { path: 'modal-nego/:id', loadChildren: './pages/modal-nego/modal-nego.module#ModalNegoPageModule', canActivate: [AuthGuard] },
  { path: 'modal-detail/', loadChildren: './pages/modal-detail/modal-detail.module#ModalDetailPageModule', canActivate: [AuthGuard] },
